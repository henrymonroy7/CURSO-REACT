...
const routes: Routes = [
  ...
  {
    path: 'noticia', loadChildren: () => import('./components/noticia/noticia.module').then(m => m.NoticiaModule)
  },
  {
    path: 'noticia-completa', loadChildren: () => import('./components/noticia-completa/noticia-completa.module').then(m => m.NoticiaCompletaModule)
  },
